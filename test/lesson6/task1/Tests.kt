...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("", dateStrToDigit("25 февраля 1993 1995"))
    }
    ...
    fun dateDigitToStr() {
        ...
        assertEquals("", dateDigitToStr("01.20.1"))
    }
    ...
    fun firstDuplicateIndex() {
        ...
        assertEquals(-1, firstDuplicateIndex("a z"))
    ...
    fun mostExpensive() {
        ...
        assertEquals("0", mostExpensive("0 0"))
    }
